...
|      [[HERO-EMNLP2020]](https://arxiv.org/abs/2005.00200)     |        Stack TF        |    RN+SlowFast    |       BT      |   16.8  |   43.4  |   57.7   |
|     [[MV-GPT-arXiv2022]](https://arxiv.org/abs/2201.08264)    |        Stack TF        |       ViViT       |       BT      |   37.3  |   65.5  |   75.1   |
...
| [[VLAB-arXiv2023]](https://arxiv.org/abs/2305.13167)        |     Stack TF     |     EVA-G     |    54.6    |    33.4    |
| [[UniVL-arXiv2020]](https://arxiv.org/abs/2002.06353)       |     Stack TF     |      S3D      |    41.8    |    28.9    |
| [[MV-GPT-arXiv2022]](https://arxiv.org/abs/2201.08264)      |     Stack TF     |     ViViT     |    48.9    |    38.7    |
| [[CLIP-DCD-PRCV2022]](https://arxiv.org/abs/2111.15162)    |     Stack TF     |      ViT      |    48.2    |    30.9    |
| [[DeCEMBERT-NAACL2021]](https://aclanthology.org/2021.naacl-main.193/)   |     Stack TF     |       RN      |    45.2    |    29.7    |
| [[mPLUG-2-ICML2023]](https://arxiv.org/abs/2302.00402)     |     Stack TF     |      ViT      |    57.8    |    34.9    |
...
|:------------------:|:--------------------------:|:----------------:|:--------------:|:----------------:|:-------------------:|
| `MSVD`               | [[Paper]](https://aclanthology.org/P11-1020/), [[Dataset]](https://www.cs.utexas.edu/users/ml/clamp/videoDescription/) |     Internet     |     Manual     | TVR, VC, VideoQA |         1.9K        |
| `MSRVTT`             | [[Paper]](https://ieeexplore.ieee.org/document/7780940), [[Dataset]](https://github.com/WingsBrokenAngel/MSR-VTT-DataCleaning) |     Internet     |     Manual     | TVR, VC, VideoQA |         7.2K        |
| `ActivityNet`        | [[Paper]](https://ieeexplore.ieee.org/document/7298698), [[Dataset]](http://activity-net.org/) |     Internet     |     Manual     | AL, TVR, VC, VMR |         5.8K        |
| `FIBER`              | [[Paper]](https://arxiv.org/abs/2104.04182), [[Dataset]](https://github.com/MichiganNLP/video-fill-in-the-blank) |     Internet     |     Manual     |    VC, VideoQA   |         28K         |
| `WildQA`             | [[Paper]](https://arxiv.org/abs/2209.06650), [[Dataset]](https://github.com/MichiganNLP/In-the-wild-QA) |     Internet     |     Manual     |      VideoQA     |         0.4K        |
| `NExT-QA`            | [[Paper]](https://arxiv.org/abs/2105.08276), [[Dataset]](https://github.com/doc-doc/NExT-QA) | Existing dataset |     Manual     |      VideoQA     |         5.4K        |
| `CausalVid-QA`       | [[Paper]](https://arxiv.org/abs/2205.14895), [[Dataset]](https://github.com/bcmi/Causal-VidQA) | Existing dataset |     Manual     |      VideoQA     |         26K         |
| `HowTo100M`          | [[Paper]](https://arxiv.org/abs/1906.03327), [[Dataset]](https://www.di.ens.fr/willow/research/howto100m/) |     Internet     |      Auto      |        PT        |         1.2M        |
| `HD-VILA-100M`       | [[Paper]](https://arxiv.org/abs/2111.10337), [[Dataset]](https://github.com/microsoft/XPretrain/blob/main/hd-vila-100m/README.md) |     Internet     |      Auto      |        PT        |         3.3M        |
| `YT-Temporal-180M`   | [[Paper]](https://arxiv.org/abs/2106.02636), [[Dataset]](https://huggingface.co/datasets/HuggingFaceM4/yttemporal180m) |     Internet     |      Auto      |        PT        |          6M         |
| `TGIF-QA`            | [[Paper]](https://arxiv.org/abs/1704.04497), [[Dataset]](https://github.com/YunseokJANG/tgif-qa) | Existing dataset |     Manual     |      VideoQA     |         71K         |
| `TGIF-QA-R`          | [[Paper]](https://dl.acm.org/doi/10.1145/3474085.3475193), [[Dataset]](https://github.com/PengLiang-cn/PGAT) | Existing dataset |  Manual, Auto  |      VideoQA     |         71K         |
| `DiDeMo`             | [[Paper]](https://arxiv.org/abs/1708.01641), [[Dataset]](https://github.com/lisaanne/localizingmoments) | Existing dataset |     Manual     |        TVR       |         11K         |
| `YouCook2`           | [[Paper]](https://arxiv.org/abs/1805.02834), [[Dataset]](http://youcook2.eecs.umich.edu/) |     Internet     |     Manual     |      TVR, VC     |          2K         |
| `HMDB-51`            | [[Paper]](https://ieeexplore.ieee.org/document/6126543), [[Dataset]](https://serre-lab.clps.brown.edu/resource/hmdb-a-large-human-motion-database/) |     Internet     |     Manual     |      TVR, AR     |         6.8K        |
| `Kinetics-400`       | [[Paper]](https://arxiv.org/abs/1705.06950), [[Dataset]](https://github.com/cvdfoundation/kinetics-dataset) |     Internet     |     Manual     |        AR        |         306K        |
| `Kinetics-600`       | [[Paper]](https://arxiv.org/abs/1808.01340), [[Dataset]](https://github.com/cvdfoundation/kinetics-dataset) |     Internet     |     Manual     |      AR, VG      |         480K        |
| `Kinetics-700`       | [[Paper]](https://arxiv.org/abs/1907.06987), [[Dataset]](https://github.com/cvdfoundation/kinetics-dataset) |     Internet     |     Manual     |        AR        |         650K        |
| `VaTeX`              | [[Paper]](https://arxiv.org/abs/1904.03493), [[Dataset]](https://eric-xw.github.io/vatex-website/about.html) | Existing dataset |     Manual     |      TVR, VC     |         41K         |
| `TVR`                | [[Paper]](https://arxiv.org/abs/2001.09099), [[Dataset]](https://github.com/jayleicn/TVRetrieval) | Existing dataset |     Manual     |        VMR       |         22K         |
| `How2R`              | [[Paper]](https://arxiv.org/abs/2005.00200), [[Dataset]](https://github.com/linjieli222/HERO) | Existing dataset |     Manual     |        VMR       |         22K         |
| `How2QA`             | [[Paper]](https://arxiv.org/abs/2005.00200), [[Dataset]](https://github.com/linjieli222/HERO) | Existing dataset |     Manual     |      VideoQA     |         22K         |
| `YouTube Highlights` | [[Paper]](https://link.springer.com/chapter/10.1007/978-3-319-10590-1_51), [[Dataset]](https://github.com/TencentARC/UMT) |     Internet     |     Manual     |        VMR       |         0.6K        |
| `TACoS`              | [[Paper]](https://aclanthology.org/Q13-1003/), [[Dataset]](https://www.mpi-inf.mpg.de/departments/computer-vision-and-machine-learning/research/vision-and-language/tacos-multi-level-corpus) | Existing dataset |     Manual     |        VMR       |         0.1K        |
| `QVHighlights`       | [[Paper]](https://arxiv.org/abs/2107.09609), [[Dataset]](https://github.com/jayleicn/moment_detr) |     Internet     |     Manual     |        VMR       |         10K         |
| `Room-to-Room`       | [[Paper]](https://arxiv.org/abs/1711.07280), [[Dataset]](https://github.com/peteanderson80/Matterport3DSimulator) | Existing dataset |     Manual     |        VLN       |         7.2K        |
| `StreetLearn`          | [[Paper]](https://arxiv.org/abs/1903.01292), [[Dataset]](https://github.com/google-deepmind/streetlearn) |     Internet     |      Auto      |        VLN       |         143K        |
| `TVSum`              | [[Paper]](https://openaccess.thecvf.com/content_cvpr_2015/html/Song_TVSum_Summarizing_Web_2015_CVPR_paper.html), [[Dataset]](https://people.csail.mit.edu/yalesong/tvsum/) |     Internet     |     Manual     |        VMR       |          50         |
| `ViTT`               | [[Paper]](https://arxiv.org/abs/2011.11760), [[Dataset]](https://github.com/google-research-datasets/Video-Timeline-Tags-ViTT) | Existing dataset |     Manual     |        VMR       |         5.8K        |
| `VidChapters-7M`     | [[Paper]](https://arxiv.org/abs/2309.13952), [[Dataset]](https://github.com/antoyang/VidChapters) |     Internet     |      Auto      |      VC, VMR     |         817K        |
| `VideoCC3M`          | [[Paper]](https://arxiv.org/abs/2204.00679), [[Dataset]](https://github.com/google-research-datasets/videoCC-data) |     Internet     |      Auto      |        PT        |         6.3M        |
| `WebVid-10M`         | [[Paper]](https://arxiv.org/abs/2104.00650), [[Dataset]](https://github.com/m-bain/webvid) |     Internet     |      Auto      |        PT        |        10.7M        |
| `COIN`               | [[Paper]](https://arxiv.org/abs/1903.02874), [[Dataset]](https://coin-dataset.github.io/) |     Internet     |     Manual     |        AS        |         12K         |
| `CrossTask`          | [[Paper]](https://arxiv.org/abs/1903.08225), [[Dataset]](https://github.com/DmZhukov/CrossTask) |     Internet     |     Manual     |        AR        |         4.7K        |
| `Alivol-10M`         | [[Paper]](https://arxiv.org/abs/2104.09411) |     Internet     |      Auto      |        PT        |         10M         |
| `LSMDC`              | [[Paper]](https://arxiv.org/abs/1501.02530), [[Dataset]](https://sites.google.com/site/describingmovies) |     Internet     |     Manual     |        TVR       |          72         |
...
| `Moments in Time`    | [[Paper]](https://arxiv.org/abs/1801.03150), [[Dataset]](http://moments.csail.mit.edu/) |     Internet     |     Manual     |        AR        |          1M         |
| `InternVid`          | [[Paper]](https://arxiv.org/abs/2307.06942), [[Dataset]](https://huggingface.co/datasets/OpenGVLab/InternVid) |     Internet     |      Auto      |        PT        |         7.1M        |
| `How2`               | [[Paper]](https://arxiv.org/abs/1811.00347), [[Dataset]](https://github.com/srvk/how2-dataset) |     Internet     |      Auto      |        VC        |        13.2K        |
| `WTS70M`             | [[Paper]](https://arxiv.org/abs/2007.14937) |     Internet     |      Auto      |        PT        |         70M         |
